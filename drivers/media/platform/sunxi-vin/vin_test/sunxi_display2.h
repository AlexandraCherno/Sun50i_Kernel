...
enum disp_fb_mode {
	...
	FB_MODE_SCREEN1 = 1,
	FB_MODE_SCREEN2 = 2,
	FB_MODE_DUAL_DIFF_SCREEN = 3,/* fb0 for screen0 and fb1 for screen1 */
	FB_MODE_DUAL_SAME_SCREEN_TB = 4, /* two screen, top buffer for screen0, bottom buffer for screen1 */
	FB_MODE_DUAL_DIFF_SCREEN_SAME_CONTENTS = 5, /* two screen, they have same contents; */
};
