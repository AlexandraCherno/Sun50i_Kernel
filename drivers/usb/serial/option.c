...
#define LONGSUNG_U9300_VENDOR_ID       0x1c9e
//#defne  LONGSUNG_U9300_VENDOR_ID2      0x2df3   

#define LONGSUNG_U9300_PRODUCT_ID        0x9b3c

/*U9507A/E/J*/
#define LONGSUNG_U9507_VENDOR_ID          0x2df3
#define LONGSUNG_U9507_PRODUCT_ID        0x9b3e

/*U8300*/
#define LONGSUNG_U8300_VENDOR_ID               0x1c9e
...
static const struct usb_device_id option_ids[] = {
	...
	{ USB_DEVICE(LONGSUNG_U9300_VENDOR_ID,LONGSUNG_U9300_PRODUCT_ID) },    /*U9300C/U9507*/
	{ USB_DEVICE(LONGSUNG_U9507_VENDOR_ID, LONGSUNG_U9507_PRODUCT_ID) },     /*U9507a/E/J*/
	{ USB_DEVICE(LONGSUNG_U8300_VENDOR_ID, LONGSUNG_U8300_PRODUCT_ID) },     /*U8300*/
			...
			const struct usb_device_id *id)
{
	...
	/* Add for longSung U9300 LTE modem begin*/
	if (serial->dev->descriptor.idVendor == cpu_to_le16(LONGSUNG_U9300_VENDOR_ID) && 
		serial->dev->descriptor.idProduct==cpu_to_le16(LONGSUNG_U9300_PRODUCT_ID) &&
		serial->interface->cur_altsetting->desc.bInterfaceNumber == 4)
	{
		printk("===ytr==Discver the 4 th interface for U9300 NDIS\n");
		return -ENODEV;

	}
		/* Add for longSung U9300 LTE modem end */
