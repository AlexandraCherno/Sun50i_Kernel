		...
		struct sunxi_ahub_daudio_priv *sunxi_ahub_daudio, int id)
{
	...
	if (sunxi_ahub_daudio->pcm_lrck_period != 0) {
		regmap_update_bits(sunxi_ahub_daudio->regmap, SUNXI_AHUB_I2S_FMT0(id),
		...
		struct snd_pcm_hw_params *params, struct snd_soc_dai *dai)
{
			...
			if (sunxi_hdmi->hdmi_format > 1) {
				...
				if (sunxi_ahub_daudio->pcm_lrck_period == 0) {
					regmap_update_bits(sunxi_ahub_daudio->regmap, 
							...
							(0x1ff<<I2S_FMT0_LRCK_PERIOD), ((24-1)<<I2S_FMT0_LRCK_PERIOD));

					regmap_update_bits(sunxi_ahub_daudio->regmap, 
							SUNXI_AHUB_I2S_FMT0(sunxi_ahub_daudio->tdm_num),
							(0x7<<I2S_FMT0_SW), (((24>>2) - 1)<<I2S_FMT0_SW));
				}
			} else {
				regmap_update_bits(sunxi_ahub_daudio->regmap,
					SUNXI_AHUB_I2S_FMT0(
				...
				if (sunxi_ahub_daudio->pcm_lrck_period == 0) {
					regmap_update_bits(sunxi_ahub_daudio->regmap, 
							SUNXI_AHUB_I2S_FMT0(sunxi_ahub_daudio->tdm_num),
							(0x1ff<<I2S_FMT0_LRCK_PERIOD), ((16-1)<<I2S_FMT0_LRCK_PERIOD));

					regmap_update_bits(sunxi_ahub_daudio->regmap, 
							SUNXI_AHUB_I2S_FMT0(sunxi_ahub_daudio->tdm_num),
							(0x7<<I2S_FMT0_SW), (((16>>2) - 1)<<I2S_FMT0_SW));
				}
			}
		} else {
			regmap_update_bits(sunxi_ahub_daudio->regmap,
	...
	case	SNDRV_PCM_FORMAT_S32_LE:
		...
		if (sunxi_ahub_daudio->pcm_lrck_period == 0) {
			regmap_update_bits(sunxi_ahub_daudio->regmap, 
					SUNXI_AHUB_I2S_FMT0(sunxi_ahub_daudio->tdm_num),
					(0x1ff<<I2S_FMT0_LRCK_PERIOD), ((32-1)<<I2S_FMT0_LRCK_PERIOD));

			regmap_update_bits(sunxi_ahub_daudio->regmap, 
					SUNXI_AHUB_I2S_FMT0(sunxi_ahub_daudio->tdm_num),
					(0x7<<I2S_FMT0_SW), (((32>>2) - 1)<<I2S_FMT0_SW));
		}
		break;
	default:
