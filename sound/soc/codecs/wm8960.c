			    ...
			    const struct i2c_device_id *id)
{
	...
	regmap_update_bits(wm8960->regmap, WM8960_POWER1, 0x002, 0x002);
	regmap_update_bits(wm8960->regmap, WM8960_ADDCTL4, 0x001, 0x001);
	regmap_update_bits(wm8960->regmap, WM8960_IFACE2, 0x040, 0x040);
